(function() {
	...
	function Lang() {
		...
		//   1. Add it to `this.names`
		//   2. Update file `merge-json.json`
		//   3. Update file `ContinuousLocalization.config`
...
ZhiUTechNamespace('ZhiUTech.Viewing.i18n');
...
(function() {
	...
	var f = {
		extend: _extend,
		each: _each,
		ajax: (typeof document !== 'undefined' ? _ajax : function() {}),
	...
	function init(options, cb) {
		...
		// else load them
		ZhiUTech.Viewing.i18n.sync.load(lngsToLoad, o, function(err, store) {
			// extend resStore with the new resources.
	...
	function loadNamespaces(namespaces, cb) {
		...
		if(lngNeedLoad.length) {
			ZhiUTech.Viewing.i18n.sync._fetch(lngNeedLoad, opts, function(err, store) {
				...
				f.each(namespaces, function(nsIndex, nsValue) {
					...
					f.each(lngNeedLoad, function(lngIndex, lngValue) {
						...
						if(todo === 0 && cb) {
							if(o.useLocalStorage) ZhiUTech.Viewing.i18n.sync._storeLocal(resStore);
							cb();
						}
					});
				});
	...
	function _find(key, options) {
		...
		if(options.lng) {
			...
			if(!resStore[lngs[0]]) {
				...
				ZhiUTech.Viewing.i18n.sync.load(lngs, o, function(err, store) {
		...
		_fetch: function(lngs, options, cb) {
			...
			if(!options.dynamicLoad) {
				...
				if(typeof options.customLoad == 'function') {
					...
					url = ZhiUTech.Viewing.Private.getResourceUrl(url);
	...
	var localize = function(domElement) {
		...
		Array.prototype.forEach.call(rootNode.querySelectorAll('[data-i18n]'), function(element) {
			...
			var translatedString = ZhiUTech.Viewing.i18n.translate(stringToTrans);
			if(translatedString) {
				if(attributeName) {
	...
	ZhiUTech.Viewing.i18n.init = init;
	ZhiUTech.Viewing.i18n.setLng = setLng;
	ZhiUTech.Viewing.i18n.preload = preload;
	ZhiUTech.Viewing.i18n.addResourceBundle = addResourceBundle;
	ZhiUTech.Viewing.i18n.removeResourceBundle = removeResourceBundle;
	ZhiUTech.Viewing.i18n.loadNamespace = loadNamespace;
	ZhiUTech.Viewing.i18n.loadNamespaces = loadNamespaces;
	ZhiUTech.Viewing.i18n.localize = localize;
	ZhiUTech.Viewing.i18n.setDefaultNamespace = setDefaultNamespace;
	ZhiUTech.Viewing.i18n.t = translate;
	ZhiUTech.Viewing.i18n.translate = translate;
	ZhiUTech.Viewing.i18n.exists = exists;
	ZhiUTech.Viewing.i18n.detectLanguage = f.detectLanguage;
	ZhiUTech.Viewing.i18n.pluralExtensions = pluralExtensions;
	ZhiUTech.Viewing.i18n.sync = sync;
	ZhiUTech.Viewing.i18n.functions = f;
	ZhiUTech.Viewing.i18n.lng = lng;
	ZhiUTech.Viewing.i18n.addPostProcessor = addPostProcessor;
	ZhiUTech.Viewing.i18n.options = o;
	ZhiUTech.Viewing.i18n.setDebugLocString = setDebugLocString;
	ZhiUTech.Viewing.i18n.clearDebugLocString = clearDebugLocString;
