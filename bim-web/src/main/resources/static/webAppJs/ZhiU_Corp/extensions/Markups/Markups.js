...
(function(){ 'use strict';
    ...
    var namespace = ZhiUTechNamespace('ZhiUTech.Viewing.Extensions.Markups.Core.Utils');
    var av = ZhiUTech.Viewing;
    var avp = ZhiUTech.Viewing.Private;
     ...
     * Mechanism is the same as in ZhiUTech.Viewing.Viewer.
     *
     * Note: All of the code here comes from ZhiUTech.Viewing.Viewer
     *
    ...
    namespace.dismissLmvHudMessage = function() {
        ...
        try {
            ...
            while (keepDismissing) {
                keepDismissing = ZhiUTech.Viewing.Private.HudMessage.dismiss();
            }
        } catch (ignore) {
    ...
    namespace.createMarkupFromSVG = function(child, editor) {
        ...
        if (typeof meta !== 'string') {
            ...
            var namespace = ZhiUTech.Viewing.Extensions.Markups.Core;
...
(function(){ 'use strict';
    ...
    ZhiUTechNamespace('ZhiUTech.Viewing.Extensions.Markups.Core');

    /**
     * Base class for all markup edit actions.
     *
     * EditActions encapsulate {@link ZhiUTech.Viewing.Extensions.Markups.Core.Markup  Markup}
     ...
     * - [CreateCircle]{@link ZhiUTech.Viewing.Extensions.Markups.Core.CreateCircle}.
     * - [DeleteCircle]{@link ZhiUTech.Viewing.Extensions.Markups.Core.DeleteCircle}.
     * - [SetCircle]{@link ZhiUTech.Viewing.Extensions.Markups.Core.SetCircle}.
     *
     * @tutorial feature_markup
     * @constructor
     * @memberof ZhiUTech.Viewing.Extensions.Markups.Core
     *
     * @param {ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore} editor
    ...
    ZhiUTech.Viewing.Extensions.Markups.Core.EditAction = EditAction;

    /**
     * Performs the action.
     */
    ZhiUTech.Viewing.Extensions.Markups.Core.EditAction.prototype.execute = function() {
     ...
     * @abstract
     */
    ZhiUTech.Viewing.Extensions.Markups.Core.EditAction.prototype.redo = function() {
     ...
     * @abstract
     */
    ZhiUTech.Viewing.Extensions.Markups.Core.EditAction.prototype.undo = function() {

    };

    /**
     * Provides a mechanism to merge consecutive actions of the same type.
     * @param {ZhiUTech.Viewing.Extensions.Markups.Core.EditAction} action - Action to check if it can be merged with 'this'.
     * @returns {boolean} Returns true if merge has been applied. Parameter will be discarded.
     */
    ZhiUTech.Viewing.Extensions.Markups.Core.EditAction.prototype.merge = function(action) {
     ...
     */
    ZhiUTech.Viewing.Extensions.Markups.Core.EditAction.prototype.isIdentity = function() {
...
(function(){ 'use strict';
    ...
    var namespace = ZhiUTech.Viewing.Extensions.Markups.Core;
    var namespaceUtils = ZhiUTech.Viewing.Extensions.Markups.Core.Utils;
...
(function(){ 'use strict';
     ...
     * [Markup]{@link ZhiUTech.Viewing.Extensions.Markups.Core.Markup}.
     *
     ...
     * [EditModeCircle.js]{@link ZhiUTech.Viewing.Extensions.Markups.Core.EditModeCircle}.
     *
     * @tutorial feature_markup
     * @constructor
     * @memberof ZhiUTech.Viewing.Extensions.Markups.Core
     *
     * @param {ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore} editor - Markups extension.
...
(function(){ 'use strict';
     ...
     * Component within {@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore MarkupsCore} extension.
     *
     * Any class extending Markup should contain at least the following methods:
     * - getEditMode()
     * - set()
     ...
     * [MarkupRectangle.js]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupRectangle}.
     *
     * @tutorial feature_markup
     * @constructor
     * @memberof ZhiUTech.Viewing.Extensions.Markups.Core
     *
     * @param {number} id - Identifier, populated with return value of {@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore#getId getId()}.
     * @param {ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore} editor - Markups extension
     * @param {Array} styleAttributes - Attributes for customization. Related to {@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore#setStyle setStyle()}.
     * @constructor
     * @category Extensions
     */
     ...
     * {@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore MarkupsCore}.
     *
     * @returns {ZhiUTech.Viewing.Extensions.Markups.Core.Markup} clone of the current markup
     */
    ...
    /**
     * Used internally by
     * {@link ZhiUTech.Viewing.Extensions.Markups.Core.Markup#clone clone()},
     ...
     * Fires event ZhiUTech.Viewing.Extensions.Markups.Core.EVENT_MARKUP_SELECTED.
     */
     ...
     * Fires event ZhiUTech.Viewing.Extensions.Markups.Core.EVENT_MARKUP_ENTER_EDITION.
     */
    proto.edit = function() {
     ...
     * Fires event ZhiUTech.Viewing.Extensions.Markups.Core.EVENT_MARKUP_CANCEL_EDITION.
     */
     ...
     * Fires event ZhiUTech.Viewing.Extensions.Markups.Core.EVENT_MARKUP_DELETE_EDITION.
     */
    ...
    /**
     * Used internally to get the {@link ZhiUTech.Viewing.Extensions.Markups.Core.EditMode EditMode}
     * associated with the current Markup.<br>
     * Implemented by classes extending this one.
     * @returns {ZhiUTech.Viewing.Extensions.Markups.Core.EditMode}
     */
     ...
     * See also
     * [getClientSize()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.Markup#getClientSize}.
     * @returns {*}
     */
     ...
     * See also
     * [getClientPosition()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.Markup#getClientPosition}.
     * @returns {*}
     */
     ...
     * This gets called by the ZhiUTech.Viewing.Extensions.Markups.Core.SetRotation edit action
     *
     * @param {Number} angle
     */
     ...
     * This gets called by the ZhiUTech.Viewing.Extensions.Markups.Core.SetSize edit action
     ...
     * [generateData()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore#generateData}
...
(function(){ 'use strict';
    ...
    var namespace = ZhiUTech.Viewing.Extensions.Markups.Core.Utils;
     ...
     * @returns {ZhiUTech.Viewing.Extensions.Markups.Core.Utils.DomeElemStyle}
     */
     ...
     * @returns {ZhiUTech.Viewing.Extensions.Markups.Core.Utils.DomElemStyle} this
     */
     ...
     *
     * @returns {ZhiUTech.Viewing.Extensions.Markups.Core.Utils.DomElemStyle}
     */
    proto.clone = function() {
 ...
 (function () { 'use strict';
     ...
     *
     * @param {ZhiUTech.Viewing.Extensions.Markups.Core.Markup} markup - the markup that should appear as selected
     */
    proto.setMarkup = function (markup) {
        ...
        if (markup) {
            var boundingBox = markup.boundingBox,
                size = this.editor.sizeFromMarkupsToClient(boundingBox.x, boundingBox.y),
    ...
    function createDragPoint(position) {
        ...
        point.className = 'selector-drag-point ZhiUTech-markups-extension-core-make-me-bigger sdp-handle-' + position;
    ...
    function createRotatePoint () {
        ...
        point.classList.add('ZhiUTech-markups-extension-core-make-me-bigger');
    ...
    function createRotationBridge() {
        ...
        rotationBridge.classList.add('ZhiUTech-markups-extension-core-make-me-bigger');
    ...
    function updateSelectorBoxPosition(x, y, rotation) {
        ...
        var boundingBox = this.markup.boundingBox; 
        var size = this.editor.sizeFromMarkupsToClient(boundingBox.x, boundingBox.y);
...
(function() { 'use strict';
    ...
    var namespace = ZhiUTechNamespace('ZhiUTech.Viewing.Extensions.Markups.Core');

    /**
     * Fired whenever the drawing tool changes. For example, when the Arrow drawing
     * tool changes into the Rectangle drawing tool.
     * See [MarkupsCore.changeEditMode()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#changeEditMode}
     * for a list of all supported drawing tools (EditModes).
     * 
     * @event ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore#EVENT_EDITMODE_CHANGED
     * @type {string}
     */
     ...
     * See also [MarkupsCore.enterEditMode()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#enterEditMode}.
     * 
     * @event ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore#EVENT_EDITMODE_ENTER
     * @type {string}
     */
     ...
     * drawing markups over the Viewer canvas.
     * See also [MarkupsCore.leaveEditMode()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#leaveEditMode}.
     * 
     * @event ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore#EVENT_EDITMODE_LEAVE
     * @type {string}
     */
     ...
     * 
     * @event ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore#EVENT_MARKUP_SELECTED
     * @type {string}
     */
     ...
     * 
     * @event ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore#EVENT_MARKUP_DRAGGING
     * @type {string}
     */
     ...
     * Internal usage only.
     * 
     * @event ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore#EVENT_MARKUP_ENTER_EDITION
     * @type {string}
     * @private
     */
     ...
     * Internal usage only.
     * 
     * @event ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore#EVENT_MARKUP_CANCEL_EDITION
     * @type {string}
     * @private
     */
     ...
     * Internal usage only.
     * 
     * @event ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore#EVENT_MARKUP_DELETE_EDITION
     * @type {string}
     * @private
     */
...
(function(){ 'use strict';
     ...
     * Rectangle markup.
     *
     * Implements a Rectangle [Markup]{@link ZhiUTech.Viewing.Extensions.Markups.Core.Markup}.
     ...
     * @constructor
     * @memberof ZhiUTech.Viewing.Extensions.Markups.Core
     * @extends ZhiUTech.Viewing.Extensions.Markups.Core.Markup
     *
     * @param {number} id
     * @param {ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore} editor
     * @constructor
...
(function(){ 'use strict';
    ...
    function MarkupTool() {
        ...
        ZhiUTech.Viewing.ToolInterface.call(this);
        ...
        this.handleKeyDown = function(event, keyCode) {
            ...
            switch (keyCode) {
                case ZhiUTech.Viewing.KeyCode.CONTROL: _ctrlDown = true; break;
                case ZhiUTech.Viewing.KeyCode.SHIFT: _shiftDown = true; break;

                case ZhiUTech.Viewing.KeyCode.x: _ctrlDown && !this.allowNav && this.coreExt.cut(); break;
                case ZhiUTech.Viewing.KeyCode.c: _ctrlDown && !this.allowNav && this.coreExt.copy(); break;
                case ZhiUTech.Viewing.KeyCode.v: _ctrlDown && !this.allowNav && this.coreExt.paste(); break;
                case ZhiUTech.Viewing.KeyCode.d:
                    ...
                    break;
                case ZhiUTech.Viewing.KeyCode.z:
                    ...
                    break;
                case ZhiUTech.Viewing.KeyCode.y: _ctrlDown && !this.allowNav && this.coreExt.redo(); break; // Also support ctrl+shift+z
                case ZhiUTech.Viewing.KeyCode.ESCAPE: this.coreExt.onUserCancel(); break;

                case ZhiUTech.Viewing.KeyCode.BACKSPACE: // Fall through
                case ZhiUTech.Viewing.KeyCode.DELETE:
                    ...
                    break;
                case ZhiUTech.Viewing.KeyCode.F12:
        ...
        this.handleKeyUp = function(event, keyCode) {
            ...
            switch (keyCode) {
                case ZhiUTech.Viewing.KeyCode.CONTROL: _ctrlDown = false; break;
                case ZhiUTech.Viewing.KeyCode.SHIFT: _shiftDown = false; break;
                default: break;
            }
...
(function(){ 'use strict';
    ...
    var namespace = ZhiUTechNamespace('ZhiUTech.Viewing.Extensions.Markups.Core');
    var namespaceUtils = ZhiUTechNamespace('ZhiUTech.Viewing.Extensions.Markups.Core.Utils');
     ...
     * @param {object} options - Same Dictionary object passed into [Viewer3D]{@link ZhiUTech.Viewing.Viewer3D}'s constructor.
     * [show()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#show}.
     * @param {boolean} [options.markupDisableHotkeys] - Disables hotkeys for copy, cut, paste, duplicate, undo, redo and deselect.
     * @param {ZhiUTech.Viewing.ToolInterface} [options.markupToolClass] - Class override for input handling.
    ...
    function MarkupsCore(viewer, options) {
        ...
        // ZhiUTech.Viewing.Private.injectCSS('extensions/Markups/Markups.css');
        ...
        viewer.addEventListener(ZhiUTech.Viewing.CAMERA_CHANGE_EVENT, function() {
            this.getStrokeWidth();
            this.getFontWidth();
        }.bind(this), { once: true });
    ...
    MarkupsCore.prototype = Object.create(ZhiUTech.Viewing.Extension.prototype);
     ...
     * @param {ZhiUTech.Viewing.Extensions.Markups.Core.MarkupTool} toolClass - Implementation or extension of MarkupTool's class.
     ...
     *
     * See also
     * [enterEditMode()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#enterEditMode} and
     * [leaveEditMode()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#leaveEditMode}
     */
     ...
     *
     * Exit Edit mode by calling [leaveEditMode()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#leaveEditMode}.
     *
     * See also
     * [show()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#show}
     ...
     * Exits Edit mode.
     *
     * See also [enterEditMode()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#enterEditMode}.
     *
     ...
     * Exit Edit mode by calling [hide()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#hide}.
     *
     * See also
     * [enterEditMode()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#enterEditMode}.
    ...
    MarkupsCore.prototype.show = function() {
        ...
        viewer.addEventListener(ZhiUTech.Viewing.VIEWER_RESIZE_EVENT, this.onViewerResizeBinded);
    ...
    MarkupsCore.prototype.hide = function() {
        ...
        viewer.removeEventListener(ZhiUTech.Viewing.CAMERA_CHANGE_EVENT, this.onCameraChangeBinded);
        viewer.removeEventListener(ZhiUTech.Viewing.VIEWER_RESIZE_EVENT, this.onViewerResizeBinded);
     ...
     * [Edit mode]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#enterEditMode}.
     */
     ...
     * [loadMarkups]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#loadMarkups}.
     *
     * Markups should have been added while in
     * [Edit mode]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#enterEditMode}.
     ...
     * Only applicable while in [Edit mode]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#enterEditMode}.
     *
     * Supported values are:
     * - `new ZhiUTech.Viewing.Extensions.Markups.Core.EditModeArrow(MarkupsCoreInstance)`
     * - `new ZhiUTech.Viewing.Extensions.Markups.Core.EditModeRectangle(MarkupsCoreInstance)`
     * - `new ZhiUTech.Viewing.Extensions.Markups.Core.EditModeCircle(MarkupsCoreInstance)`
     * - `new ZhiUTech.Viewing.Extensions.Markups.Core.EditModeCloud(MarkupsCoreInstance)`
     * - `new ZhiUTech.Viewing.Extensions.Markups.Core.EditModeText(MarkupsCoreInstance)`
     * - `new ZhiUTech.Viewing.Extensions.Markups.Core.EditModeFreehand(MarkupsCoreInstance)`
     * - `new ZhiUTech.Viewing.Extensions.Markups.Core.EditModePolyline(MarkupsCoreInstance)`
     * - `new ZhiUTech.Viewing.Extensions.Markups.Core.EditModePolycloud(MarkupsCoreInstance)`
     *
     * This function fires event `ZhiUTech.Viewing.Extensions.Markups.Core.EVENT_EDITMODE_CHANGED`.
     ...
     *
     * @return {boolean} Whether [allowNavigation()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#allowNavigation} can succeed.
     */
     ...
     * @private
     */
    ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore.prototype.activateTool = function(isActive) {
        if (isActive) {
            if (!this.cachedNavigationTool) {
                this.cachedNavigationTool = this.viewer.getActiveNavigationTool();
                this.viewer.addEventListener(ZhiUTech.Viewing.TOOL_CHANGE_EVENT, this.onToolChangeBinded);
            }
            ...
            this.viewer.removeEventListener(ZhiUTech.Viewing.TOOL_CHANGE_EVENT, this.onToolChangeBinded);
        }
    };
     ...
     * @private
     */
    ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore.prototype.onToolChange = function(event) {
    ...
    ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore.prototype.onUnitsCalibrationStarts = function(event) {
        if (this.duringEditMode) {
            this.hide();
        }
    };
     ...
     * See also
     * [cut()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#cut} and
     * [paste()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#paste}.
     */
     ...
     * See also
     * [copy()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#copy} and
     * [paste()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#paste}.
     */
     ...
     * See also
     * [copy()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#copy} and
     * [cut()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#cut}.
     */
     ...
     * See also
     * [redo()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#redo} and
     * [isUndoStackEmpty()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#isUndoStackEmpty}.
     */
     ...
     * See also
     * [undo()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#undo},
     * [isRedoStackEmpty()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#isRedoStackEmpty}.
     */
    ...
    /**
     * Returns true when [undo()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#undo}
     * produces no changes.
    ...
    /**
     * Returns true when [redo()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#redo}
     * produces no changes.
     ...
     * See also
     * [getSelection()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#getSelection}.
     * @param {string} id Markup identifier.
     * @returns {ZhiUTech.Viewing.Extensions.Markups.Core.Markup} Returns markup object.
     */
     ...
     * See also
     * [getMarkup()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#getMarkup}.
     * @param {ZhiUTech.Viewing.Extensions.Markups.Core.Markup|null} markup The markup instance to select. Set the value to null to deselect a markup.
     */
     ...
     * See also
     * [selectMarkup()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#selectMarkup}.
     * @returns {ZhiUTech.Viewing.Extensions.Markups.Core.Markup|null} Returns selected markup object; null if no markup is selected.
     */
     ...
     * [Edit mode]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#enterEditMode}.
     * @param {ZhiUTech.Viewing.Extensions.Markups.Core.Markup} markup - Markup object.
     * @param {boolean} [dontAddToHistory] Whether delete action can be [undone]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#undo}.
     */
     ...
     *
     * See also
     * [unloadMarkups()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#unloadMarkups}, and
     * [hideMarkups()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#hideMarkups}.
     *
     * @param {string} markupString - SVG string with markups. See also [generateData()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#generateData}.
     ...
     *
     * See also
     * [loadMarkups()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#loadMarkups} and
     * [enterEditMode()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#enterEditMode}.
     *
     ...
     * See also
     * [loadMarkups()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#loadMarkups},
     * [unloadMarkupsAllLayers()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#unloadMarkupsAllLayers},
     * [clear()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#clear},
     * [hide()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#hide}, and
     * [hideMarkups()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#hideMarkups}.
     *
     ...
     * See also
     * [loadMarkups()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#loadMarkups},
     * [unloadMarkups()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#unloadMarkups},
     * [clear()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#clear},
     * [hide()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#hide}, and
     * [hideMarkups()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#hideMarkups}.
     */
     ...
     * Use the [showMarkups()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#showMarkups} method to make
     * them visible again; no additional parsing is required.
     *
     * See also
     * [showMarkups()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#showMarkups},
     * [unloadMarkups()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#unloadMarkups}, and
     * [loadMarkups()]{@link ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore/#loadMarkups}.
     *
    ...
    ZhiUTech.Viewing.theExtensionManager.registerExtension('ZhiUTech.Viewing.MarkupsCore', MarkupsCore);
})();
...
(function(){ 'use strict';
     ...
     *
     * Implements an [EditAction]{@link ZhiUTech.Viewing.Extensions.Markups.Core.EditAction}
     * for creating a Circle [Markup]{@link ZhiUTech.Viewing.Extensions.Markups.Core.Markup}.
     * Included in documentation as an example of how to create
     ...
     * @constructor
     * @memberof ZhiUTech.Viewing.Extensions.Markups.Core
     * @extends ZhiUTech.Viewing.Extensions.Markups.Core.EditAction
     *
     * @param editor
     * @param id
     * @param position
...
(function(){ 'use strict';
     ...
     * 
     * Implements an [EditAction]{@link ZhiUTech.Viewing.Extensions.Markups.Core.EditAction}
     * for deleting a Circle [Markup]{@link ZhiUTech.Viewing.Extensions.Markups.Core.Markup}.
     * Included in documentation as an example of how to create
...
(function(){ 'use strict';
     ...
     *
     * Implements an [EditAction]{@link ZhiUTech.Viewing.Extensions.Markups.Core.EditAction}
     * for editing properties of a Circle [Markup]{@link ZhiUTech.Viewing.Extensions.Markups.Core.Markup}.
     * Included in documentation as an example of how to create
...
(function(){ 'use strict';
     ...
     *
     * Implements a Circle [EditMode]{@link ZhiUTech.Viewing.Extensions.Markups.Core.EditMode}.
     * Included in documentation as an example of how to create
     ...
     * @constructor
     * @memberof ZhiUTech.Viewing.Extensions.Markups.Core
     * @extends ZhiUTech.Viewing.Extensions.Markups.Core.EditMode
     * @param {ZhiUTech.Viewing.Extensions.Markups.Core.MarkupsCore} editor
     * @category Extensions
     */
...
(function(){ 'use strict';
    ...
    function EditModeDimension(editor) {
        ...
        var viewer = this.viewer;
        var measureExt = viewer.getExtension('ZhiUTech.Measure');
    ...
    proto.getDistance = function() {
        ...
        if (this.viewer.model && this.measurement.distanceXYZ) {
            var d = ZhiUTech.Viewing.Private.convertUnits(this.viewer.model.getUnitString(), this.sharedMeasureConfig.units, this.sharedMeasureConfig.calibrationFactor, this.measurement.distanceXYZ);
            return ZhiUTech.Viewing.Private.formatValueWithUnits(d, this.sharedMeasureConfig.units, 3, this.sharedMeasureConfig.precision);
        }
    ...
    proto.onMouseDown = function(event) {
        ...
        if (ZhiUTech.Viewing.Private.isRightClick(event, this.viewer.navigation)) {
            return;
        }
    ...
    proto.handleKeyDown = function (e) {
        ...
        if (e.keyCode === ZhiUTech.Viewing.KeyCode.ENTER) {
            return;
        }
        ...
        if (e.keyCode === ZhiUTech.Viewing.KeyCode.BACKSPACE) {
...
(function(){ 'use strict';
    ...
    proto.setActive = function(textMarkup, firstEdit) {
        ...
        var placeholderText = ZhiUTech.Viewing.i18n.translate(this.defaultText);
