...
function Initialize_ZhiUTech_NewTree(zhiu, needDiv = false) {
    ...
    function _InitilizeListener() {
        ...
        // zhiu.viewer.addEventListener(ZhiUTech.Viewing.AGGREGATE_ISOLATION_CHANGED_EVENT, function (arg) {
        //     console.log(" >LJason< 日志：隔tm例",arg);
        // });
    }
    ...
    function _InitializeTreeDivisionAndObject() {
        ...
        if (needDiv) {
            ...
            member._div = document.createElement("div");
            member._div.className = "ztree";
            member._div.id = "zhiuZTree";
            member._div.style.cssText = "position: absolute;top:70px;left:-500px;width:400px;height:500px;z-index:10000;background:#828282;overflow-x:auto;";
            document.body.appendChild(member._div);
            member._divNormal = document.createElement("div");
            member._divNormal.className = "ztree";
            member._divNormal.id = "zhiuZTreeNormal";
            member._divNormal.style.cssText = "position: absolute;top:570px;left:-500px;width:400px;height:500px;z-index:10000;background:#828282;overflow-x:auto;";
            document.body.appendChild(member._divNormal);
        }
