...
function Initialize_ZhiUTech_UI(core,isLeftPanelVisible=true,isRightPanelVisble=true,isRightToolBarVisible=true) {
    ZhiUTech_UI = {
        // region 成员
        _zhiu: core,
        zhiu_rightNav: {},
        ...
        Init: function () {
            ...
            ZhiUTech_UI._FirstPersonButtonAction();
        ...
        AddFullScreenButton: function () {
            ...
            if(!isRightToolBarVisible){
                ZhiUTech_UI.ZhiUTech_FullScreen.style.display="none";
            }
        ...
        AddModelStructureTree: function () {
            ...
            let ModelStructureTree_Button = document.createElement('div');
            ModelStructureTree_Button.className = "zhiu_model_structure_tree ZhUfont icon-qianjin zhiu_left";
            //按钮提示
            let button_tip = document.createElement('div');
            ...
            let ModelStructureTree_box = document.createElement('div');// NormalTree
            ModelStructureTree_box.className = "ModelStructureTree_box";
            ModelStructureTree_box.style.gridRow="2/3";
            ModelStructureTree_box.style.position="relative";
            let ModelStructureTree_other = document.createElement('div');
            ModelStructureTree_other.className = "ModelStructureTree_other";
            ModelStructureTree_other.style.display="none";
            ModelStructureTree_other.style.gridRow="2/3";
            ModelStructureTree_other.style.position="relative";
            ...
            let zhiuGLTree = document.createElement('div');
            zhiuGLTree.id = "_zhiuGLTree";
            zhiuGLTree.style.position="absolute";
            zhiuGLTree.style.top="0px";
            zhiuGLTree.style.bottom="0px";
            zhiuGLTree.style.left="0px";
            zhiuGLTree.style.right="0px";
            ModelStructureTree_other.appendChild(zhiuGLTree);
            let zhiuGLTreeNormal = document.createElement('div');
            zhiuGLTreeNormal.id = "_zhiuGLTreeNormal";
            zhiuGLTreeNormal.style.position="absolute";
            zhiuGLTreeNormal.style.top="0px";
            zhiuGLTreeNormal.style.bottom="0px";
            zhiuGLTreeNormal.style.left="0px";
            zhiuGLTreeNormal.style.right="0px";
            core._member._nowTreeName=zhiuGLTreeNormal.id;
            ModelStructureTree_box.appendChild(zhiuGLTreeNormal);
            ...
            ZhiUTech_MsgCenter.L_SendMsg("GLTREE初始化成功");
            ...
            $('.ModelStructureTree_content_title div:nth-child(1)').click(function () {
                ...
                ZhiUTech_MsgCenter.L_SendMsg("刷新树状图聚焦位置",zhiuGLTreeNormal.id);
                core._member._nowTreeName=zhiuGLTreeNormal.id;
            });
            $('.ModelStructureTree_content_title div:nth-child(2)').click(function () {
                ...
                ZhiUTech_MsgCenter.L_SendMsg("刷新树状图聚焦位置",zhiuGLTree.id);
                core._member._nowTreeName=zhiuGLTree.id;
            });
            /*浮动显示tips*/
        ...
        AddToobarRight: function () {
            ...
            if(!isRightToolBarVisible){
                ZhiUTech_UI.ZhiUTech_ToolBar_Right.style.display="none";
            }
            ...
            ZhiUTech_UI.ToobarAddButtonRight('Zhiu_firstPerson', '漫游', 'icon-manyou', ZhiUTech_UI._ToggleFirstPerson);
        },
        ...
        _FirstPersonButtonAction:function(){
            $("#Zhiu_firstPerson").click(function () {
                $(this).siblings().removeClass('boxShadow')
                if ($(this).hasClass("boxShadow")) {
                    $(this).removeClass('boxShadow')
                    ZhiUTech_UI._CloseAllSecondMenu();
         ...
         * @private
         */
        _ToggleFirstPerson:function(){
            ZhiUTech_MsgCenter.L_SendMsg("开关第一人称",!$("#Zhiu_firstPerson").hasClass('boxShadow'));
        },
        //小房子下拉列表(视角)部分
        ...
        showNav(btn, navDiv, direction) {
            btn.on('click', function () {
                ...
                if (direction === "zhiu_right") {
                    ...
                    core._member._isTreePanelOpen=true;
                    navDiv.css({
                        left: "0px",
                        transition: "left 1s"
                    });
                    ZhiUTech_UI.zhiu_leftNav.css("width","400px");
        ...
        hideNav(direction) {
            if (direction == "zhiu_right") {
                ...
                core._member._isTreePanelOpen=false;
    ...
    if(!isLeftPanelVisible){
        ZhiUTech_UI.zhiu_leftNav.hide();
    }
    if(!isRightPanelVisble){
        ZhiUTech_UI.zhiu_rightNav.hide();
    }
